...
def weather_aug(self,augmented_images_path,augmented_labels_path):
        img = cv2.imread(augmented_images_path)
        ...
        with open(augmented_labels_path, "r") as label_file:
        ...
        try:
            ...
            cv2.imwrite(augmented_images_path, augmented_image)
        
            with open(augmented_labels_path, "w") as augmented_label_file:
